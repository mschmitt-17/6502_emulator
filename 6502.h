...
#define OP_BIT      0x04 // test bits in memory with accumulator
#define OP_AND      0x05 // and memory with accumulator
#define OP_ROL      0x06 // rotate one bit left
#define OP_PHP      0x08 // push processor status on stack
#define OP_EOR      0x09 // xor memory with accumulator
#define OP_LSR      0x0A // shift right one bit
#define OP_ADC      0x0D // add memory to accumulator with carry
#define OP_ROR      0x0E // rotate one bit right
#define OP_STY      0x10 // store index Y in memory
#define OP_BPL      0x10 // branch on N = 0
#define OP_STA      0x11 // store accumulator in memory
#define OP_STX      0x12 // store index X in memory
#define OP_LDY      0x14 // load index Y with memory
#define OP_LDA      0x15 // load accumulator with memory
#define OP_LDX      0x16 // load index X with memory
#define OP_CLC      0x18 // clear carry flag
#define OP_CPY      0x18 // compare memory and index Y
#define OP_CMP      0x19 // compare memory and accumulator
#define OP_DEC      0x1A // decrement memory by one
#define OP_CPX      0x1C // compare memory and index X
#define OP_SBC      0x1D // subtract memory from accumulator with borrow
#define OP_INC      0x1E // increment memory by one
